...
from persondetect import YOLO3
from mot.deepsort.tracker import Tracker
from utils.util import draw_bboxes

import time

video_path = "/home/vsa/pyproject/VSA_Server/test_data/orgin/"
result_path = ""/home/vsa/pyproject/VSA_Server/test_data/results/""
fps = 25
alternation = 1
...
deepsort = Tracker(0, "feature/checkpoint/ckpt.t7")
index = 0
