...
def pixel2camera(camera_num, pixel_x, pixel_y):
    path_model = '/home/kdy/skdy/IDS/model_IDS/location'
...
def draw_with_cv2(map_x, map_y):
    ...
    #cv2.imshow('2', img)    //由于cv2环境问题会报错，故将imshow函数改为imwrite函数

if __name__ == '__main__':
    results_path='/home/kdy/skdy/IDS/experiment/pixel_2_map/person_mot/test'
    ...
    for root, dirs, files in os.walk(results_path):
        ...
        # 遍历所有的子文件夹
        #for camera_id in dirs:
        #    print(camera_id)
            
        # 遍历所有的子文件
        #for results_txt in files:
        #    print(results_txt)
        for result_txt in files:
            result_txt_path=os.path.join(root,result_txt)
            #print(result_txt_path)
            camera_id=int(pattern.search(result_txt_path).group(1))
            #print(camera_id)
            #get_location_from_txt(camera_num, results_txt_path, trail_img_path, flag_draw_trail=False, flag_save_plt=True)
            get_location_from_txt(camera_id,result_txt_path,root)
...
#    print('map:', map_x, map_y)
    ...
    # det_txt_path = '/home/syx/workspace/pixel_2_map/test/1571968883.txt'
    # camera_num = 18
    # person_trail_img_path = '/home/syx/workspace/pixel_2_map/test/img'
    # get_location_from_txt(camera_num, det_txt_path, person_trail_img_path, flag_draw_trail=True,
    #                       flag_save_plt=True)
    
#    draw_trail_from_list(18,'/home/kdy/skdy/IDS/experiment/pixel_2_map/test/18_path_test.txt')
    #draw_with_cv2(map_x, map_y)
"""
maps[17] = [1879, -13593]
maps[18] = [-2412, 13884, 280]
maps[19] = [-24040, -18147, 280]
