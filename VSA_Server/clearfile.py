...
result_list = os.listdir(mot_result_path)
for i in range(len(result_list)):
    file_list = os.listdir(os.path.join(mot_result_path, result_list[i]))
    for j in range(len(file_list)):
        os.remove(os.path.join(mot_result_path, result_list[i], file_list[j]))

result_list = os.listdir(detect_result_path)
for i in range(len(result_list)):
    file_list = os.listdir(os.path.join(detect_result_path, result_list[i]))
    for j in range(len(file_list)):
        os.remove(os.path.join(detect_result_path, result_list[i], file_list[j]))
